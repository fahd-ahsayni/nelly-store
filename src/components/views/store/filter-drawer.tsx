      ...
      <div className="fixed inset-0 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            <DialogPanel className="pointer-events-auto w-screen max-w-md transform transition-all duration-500 ease-in-out data-closed:translate-x-full">
              <form
                ref={formRef}
                onSubmit={(e) => {
                  e.preventDefault();
              ...
              >
                ...
                <div className="relative mt-6 flex-1 px-4 sm:px-6 flex flex-col">
                  {/* ScrollArea now wraps the filter sections */}
                  ...
                  {/* Apply Filters Button - fixed to bottom with no margin-top */}
