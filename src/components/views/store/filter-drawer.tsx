...
export default function FilterDrawer() {
  ...
  const [localPriceRange, setLocalPriceRange] = useState(pendingFilterState.priceRange);
  ...
  const uniqueColors = [...new Map(colors.map(item => [item.hex, item])).values()];
  ...
  const activePendingFilterCount = 
    ...
    (pendingFilterState.priceRange.min > 0 || pendingFilterState.priceRange.max < 1000 ? 1 : 0);
      ...
      <div className="fixed inset-0 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden">
          <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            <DialogPanel
              className="pointer-events-auto w-screen max-w-md transform transition-all duration-500 ease-in-out data-closed:translate-x-full"
            >
              <form ref={formRef} onSubmit={(e) => { e.preventDefault(); handleApplyFilters(); }} className="flex h-full flex-col overflow-y-auto bg-white py-6 shadow-xl">
                <div className="px-4 sm:px-6">
                  ...
                  <div className="mt-3 text-sm text-zinc-500">
                    {filteredProductCount} of {totalProductCount} products
                    {activePendingFilterCount > 0 && (
                      <span className="ml-1">
                        ({activePendingFilterCount} filter{activePendingFilterCount !== 1 ? 's' : ''} selected)
                      </span>
                    )}
                  </div>
                </div>
                ...
                <div className="relative mt-6 flex-1 px-4 sm:px-6 space-y-8">
                  ...
                  <div>
                    ...
                    <select
                      value={pendingFilterState.sortBy}
                      onChange={(e) => updatePendingSortBy(e.target.value as any)}
                      className="block w-full py-2 px-3 border border-zinc-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-rose-500 focus:border-rose-500 text-sm"
                    >
                  ...
                  <div className="flex justify-between items-center border-t border-zinc-200 pt-6">
                    <h3 className="text-sm font-semibold text-zinc-900">Active Filters</h3>
                    <button 
                      type="button"
                  ...
                  <div className="border-t border-zinc-200 pt-6">
                    <div className="flex justify-between items-center">
                      <h3 className="text-sm font-semibold text-zinc-900 mb-4">Availability</h3>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center">
                        ...
                        />
                        <label htmlFor="stock-all" className="ml-3 text-sm text-zinc-600">
                          Show All
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-zinc-300 text-rose-600 focus:ring-rose-500"
                        />
                        <label htmlFor="stock-in" className="ml-3 text-sm text-zinc-600">
                          In Stock Only
                        </label>
                      </div>
                      <div className="flex items-center">
                        <input
                          ...
                          className="h-4 w-4 border-zinc-300 text-rose-600 focus:ring-rose-500"
                        />
                        <label htmlFor="stock-out" className="ml-3 text-sm text-zinc-600">
                          Out of Stock Only
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="border-t border-zinc-200 pt-6">
                    <div className="flex justify-between items-center">
                      <h3 className="text-sm font-semibold text-zinc-900 mb-4">Colors</h3>
                  ...
                  <div className="border-t border-zinc-200 pt-6">
                    <div className="flex justify-between items-center">
                      <h3 className="text-sm font-semibold text-zinc-900 mb-4">Sizes</h3>
                  ...
                  <div className="sticky bottom-0 bg-white py-4 border-t border-zinc-200 mt-8">
                    <div className="flex space-x-4">
                      <button
                        type="button"
                        onClick={clearAllFilters}
